...
const createCustomIcon = (status: string) => {
  let iconColor;
  switch (status) {
    case 'active': iconColor = '#10B981'; // green-500
    case 'maintenance': iconColor = '#F59E0B'; // yellow-500
    default: iconColor = '#EF4444'; // red-500
  }
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <nav className="flex flex-wrap justify-center gap-4 md:gap-6">
              <a href="/dashboard" className="hover:text-green-200 transition-colors flex items-center">
              ...
              <a href="/analytics" className="hover:text-green-200 transition-colors flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
