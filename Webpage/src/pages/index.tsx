...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      console.log("Session Guest:", sessionGuest);

      if (sessionGuest) {
        console.log("Guest session active");
        setIsGuest(true);

        // Set timeout for guest session expiration (30 minutes)
  ...
  if (!isMounted) {
    // Optional: Show loading state during SSR/initial render
        ...
        <div className="bg-card rounded-lg shadow-lg border max-w-md w-full p-8 text-center">
          ...
          <div className="mt-6 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
            <p className="text-xs text-yellow-700">
              <strong>Note:</strong> Guest sessions are temporary and will
              expire after 30 minutes of inactivity or when you navigate away
              from the site.
            </p>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 max-w-sm w-full">
              ...
              <p className="text-gray-600 mb-4">
                Redirecting to MediCoAuth login...
              </p>
              ...
              <div className="bg-gray-50 p-4 rounded border-2 border-dashed border-gray-300 text-center">
                <p className="text-sm text-gray-500">
                  MediCoAuth Login Component
                </p>
                <p className="text-xs text-gray-400 mt-1">
                  Connect your login component here
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    You're in <strong>Guest Mode</strong>. Sign in for full
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm border">
                ...
                <ul className="space-y-3 text-green-600 text-sm sm:text-base">
                  <li>
                    <a
                      href="/RecentScans"
                      className="block p-2 sm:p-3 rounded hover:text-green-800 hover:bg-green-100"
                    >
                      Recent Scans
                    </a>
                  </li>
              ...
              <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm border">
                ...
                <ul className="space-y-3 text-green-600 text-sm sm:text-base">
                  ...
                  <li>
                    <a
                      href="/WeedWiseCoverageEfficiencyPage"
                      className="block p-2 sm:p-3 rounded hover:text-green-800 hover:bg-green-100"
                    >
                      Coverage Efficiency
                    </a>
