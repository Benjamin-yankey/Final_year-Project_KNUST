const Contact = () => (
  <div className="p-8 max-w-3xl mx-auto">
    ...
    <p className="text-muted-foreground mb-4">Reach our team at support@weedwise.example</p>
    <form className="space-y-4">
      ...
      <textarea className="border rounded w-full p-2" rows={5} placeholder="Message" />
